...
<div>
    <table border="1">
        ...
        <tr>
            <td>
                <p><b>ID: </b>${categorias.id}</p>
                <p><b>Categoria: </b> ${categorias.category}</p>
                <p><b>Utilizador: </b> ${categorias.utilizador}</p>
            </td>
        </tr>
    </table>
    <br>
    <security:authorize access="hasRole('ROLE_ADMIN')">
    <form action="/editcategory/${categorias.id}" method="get" style="display: inline">
