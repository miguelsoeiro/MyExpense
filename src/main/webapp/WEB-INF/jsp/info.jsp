...
<html>
<head>
        <title>Informações da Despesas</title>
        <ul>
...
<body>
    <div>
            <table border="1">
                ...
                <tr>
                    <td>
                        <p><b>ID:</b>${utilizador.id}</p>
                        <p><b>Descrição:</b> ${utilizador.description}</p>
                        <p><b>Categoria:</b> ${utilizador.category}</p>
                        <p><b>Valor:</b> ${utilizador.value}</p>
                        <p><b>Local:</b> ${utilizador.local}</p>
                        <p><b>Data:</b> ${utilizador.date}</p>
                    </td>
                </tr>
            </table>
         <br>
         <form action="/edit/${utilizador.id}" method="get" style="display: inline">
              <input type="submit" value="Editar" />
         </form>
        <form action="/delete/${utilizador.id}" method="post" style="display: inline">
