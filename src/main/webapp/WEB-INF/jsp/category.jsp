...
<div>
    <security:authorize access="hasRole('ROLE_ADMIN')">
        ...
        <p>
        <form:form method="POST" modelAttribute="categoryForm" action="/category">
            <p>
                <form:label path="category"><b>Adicionar Nova Categoria:</b></form:label>
                <form:input path="category" label="Categoria" />
        ...
        <table border="1">
            ...
            <c:if test="${not empty categorias}">
                <c:forEach var="categoriasValue" items="${categorias}">
                    <tr>
                        <td>${categoriasValue.category}</td>
                        <td><a href="/infocategory/${categoriasValue.id}">Mais Detalhes</a></td>
                    </tr>
                </c:forEach>
            </c:if>
        </table>
